...
const ifos: Ifo[] = [
  ...
  {
    id: 'soteria',
    address: '0xB5db923731A58874d595a190fA76DdcD5f579034',
    isActive: true,
    name: 'Froggy Farm',
    subTitle: 'Meme Inspired Yield Farm on Scroll',
    description:
      'Froggy Farm: Where Memes Meet DeFi Magic! The FIRST goose fork on Scroll with ENDLESS DeFi solutions!',
    launchDate: 'OCT. 29',
    launchTime: '12 UTC',
    saleAmount: '3,000,000 FROG',
    raiseAmount: '6 WETH',
    projectSiteUrl: 'froggyfarm.xyz',
    currency: 'WETH',
    currencyAddress: '0xA1077a294dDE1B09bB078844df40758a5D0f9a27',
    tokenDecimals: 18,
    releaseBlockNumber: 17749908,
  },
]
